    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
			...
			/*if(afm.getCurrentModuleName() !== 'vhChecklist'){*/
				var html = '<div class="' + s.theme + ' dw-' + s.display + (prefix ? ' dw' + prefix : '') + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="header-text-date-time-picker cjl-header-text">'+s.headerDisplayText+'</div>' : '')) + '<div style="margin:6% 0 0 4%;padding-top: 3%;" ><div class="dwcc '+s.pickerIconClassName+'"></div></div>';
				$('.header-text-date-time-picker').addClass('cjl-header-text');
			/*}
			else{
				var html = '<div class="' + s.theme + ' dw-' + s.display + (prefix ? ' dw' + prefix : '') + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="header-text-date-time-picker">'+s.headerDisplayText+'</div>' : '')) + '<div style="margin:6% 0 0 4%;padding-top: 3%;" ><div class="dwcc '+s.pickerIconClassName+'"></div></div>';
			}*/
            // Create wheels containers /***** HACK.. Changed the position of the header and added a new Title header ****/
          
            if(s.showTimeIcon) {
            	html += '<div style="margin: -4% 0% 0 -4%;"><div class = "dwtc picker-icon-time"></div></div>';
            }
            ...
            $.each(s.wheels, function (i, wg) { // Wheel groups
                ...
                $.each(wg, function (j, w) { // Wheels
                    wheels[l] = w;
                    html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwb-e dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></div>' : '') + '<div class="dwww"><div class="dww" style="height:' + (s.rows * hi) + 'px;min-width:' + 55 + 'px;"><div class="dw-ul">';
                    // Create wheel values
            ...
            html += '<div class="dwv"></div></div>' + (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb dwb-e">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb dwb-e">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb dwb-e">' + s.cancelText + '</span></span></div></div>' : '') + '</div></div></div>';
            dw = $(html);
