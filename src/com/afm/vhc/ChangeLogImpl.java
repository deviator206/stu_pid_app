...
public  class ChangeLogImpl extends com.sybase.persistence.AbstractEntity implements com.sybase.persistence.ChangeLog, com.sybase.persistence.BusinessObject, com.sybase.reflection.ClassWithMetaData
{
    ...
    private static com.afm.vhc.intrnl.ChangeLogImplMetaData META_DATA = new com.afm.vhc.intrnl.ChangeLogImplMetaData();
    ...
    protected static com.sybase.sup.client.persistence.EntityDelegate DELEGATE = 
        com.sybase.sup.client.persistence.DelegateFactory.createEntityDelegate("ChangeLogImpl", com.afm.vhc.ChangeLogImpl.class, "VHC.ChangeLogImpl", META_DATA, com.afm.vhc.VHCDB.getDelegate());
    ...
    /**
     * Creates an instance of com.afm.vhc.ChangeLogImpl  
     */
     ...
     */
    public static com.afm.vhc.ChangeLogImpl find(com.afm.vhc.ChangeLogKey id)
    {
        ...
        try
        {
            ...
            return (com.afm.vhc.ChangeLogImpl)(DELEGATE.findEntityWithKeys(keys));
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     */
    public static com.afm.vhc.ChangeLogImpl load(com.afm.vhc.ChangeLogKey id)
    {
        return (com.afm.vhc.ChangeLogImpl)(DELEGATE.load(id));
    }
    
    /**
     * Get surroget key of the mobile business object  
     */
    public com.afm.vhc.ChangeLogKey _pk()
    {
        return (com.afm.vhc.ChangeLogKey)i_pk();
    }
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl> findWithQuery(com.sybase.persistence.Query query)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl>)(Object)DELEGATE.findWithQuery(query, com.afm.vhc.ChangeLogImpl.class);
    }
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl> getPendingObjects(int skip, int take)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl>)(Object)DELEGATE.getPendingObjects(skip, take);
    }
    
    /**
     * Returns the MBOs that are updated locally but not submmited.  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl> getPendingObjects()
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.ChangeLogImpl>)(Object)DELEGATE.getPendingObjects();
    }
    ...
    {
        return com.afm.vhc.LogRecordImpl.findByEntity("ChangeLogImpl", keyToString());
    }
    ...
    public static void deleteChangeLogs()
    {
        try
        {
            String sql = "truncate table vhc_1_0_changelogimpl";
        	com.sybase.persistence.ConnectionWrapper _conn = com.afm.vhc.VHCDB.acquireDBWriteConnection();
        ...
        {
            com.afm.vhc.VHCDB.releaseDBConnection();
        }
    }  
