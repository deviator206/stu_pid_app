...
public  class OperationReplay extends com.sybase.persistence.AbstractReadOnlyEntity implements com.sybase.persistence.OperationReplay, com.sybase.reflection.ClassWithMetaData
{
    ...
    private static com.afm.vhc.intrnl.OperationReplayMetaData META_DATA = new com.afm.vhc.intrnl.OperationReplayMetaData();
    ...
    protected static com.sybase.sup.client.persistence.EntityDelegate DELEGATE = 
        com.sybase.sup.client.persistence.DelegateFactory.createEntityDelegate("OperationReplay", com.afm.vhc.intrnl.OperationReplay.class, "VHC.OperationReplay", META_DATA, com.afm.vhc.VHCDB.getDelegate());
    ...
    /**
     * Creates an instance of com.afm.vhc.intrnl.OperationReplay  
     */
     ...
     */
    public static com.afm.vhc.intrnl.OperationReplay find(long id)
    {
        ...
        try
        {
            ...
            return (com.afm.vhc.intrnl.OperationReplay)(DELEGATE.findEntityWithKeys(keys));
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     */
    public static com.afm.vhc.intrnl.OperationReplay load(long id)
    {
        return (com.afm.vhc.intrnl.OperationReplay)(DELEGATE.load(id));
    }
    ...
    /**
     * Find a List of Com.afm.vhc.intrnl.OperationReplay
     * @exception PersistentException Thrown if unable to retrieve mobile business object.
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay> findReadyToFinish(int skip, int take)
    {
        String intervalName = null;
        if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
        {
        ...
        try
        {
                ...
                String _selectSQL = " r.\"a\",r.\"c\",r.\"d\",r.\"e\",r.\"f\",r.\"g\",r.\"h\",r.\"i\",r.\"j\",r.\"b\" from \"vhc_1_0_operationreplay\" r where r.\"j\" = 1 order by r.\"b\"";
                ...
                com.sybase.collections.GenericList<Object> res = DELEGATE.findWithSQL(_selectSQL, dts, values, ids, skip, take, com.afm.vhc.intrnl.OperationReplay.class);
                return (com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay>)(Object)res;
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     * Find a list of com.afm.vhc.intrnl.OperationReplay  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay> findReadyToFinish()
    {
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay> getPendingObjects(int skip, int take)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay>)(Object)DELEGATE.getPendingObjects(skip, take);
    }
    
    /**
     * Returns the MBOs that are updated locally but not submmited.  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay> getPendingObjects()
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.intrnl.OperationReplay>)(Object)DELEGATE.getPendingObjects();
    }
    ...
    {
        return com.afm.vhc.LogRecordImpl.findByEntity("OperationReplay", keyToString());
    }
