...
public final class VHCDB extends com.sybase.persistence.Database
{
    ...
    private static com.sybase.persistence.ConnectionProfile _profile =
        new com.sybase.persistence.ConnectionProfile("VHC_V011_0");
    ...
    private static class VHCDBHolder {
       final static VHCDB instance = new VHCDB();
    }

    public static VHCDB getInstance() {
       return VHCDBHolder.instance;
    }
    ...
    private static com.afm.vhc.intrnl.VHCDBMetaData META_DATA = new com.afm.vhc.intrnl.VHCDBMetaData(DELEGATE);
    /**
    ...
    public static synchronized void initialize()
    {
        ...
        {
            _profile.setProperty("databaseFile", "VHC_V011_0.ulj");
            getConnectionProfile().setPageSize(4096);
        }
        ...
        DELEGATE.init("vhc:1.0", "com.afm.vhc", META_DATA, _profile, getDSI());
    }
    ...
    {
        return (com.sybase.collections.GenericList<com.sybase.persistence.LogRecord>)(Object)(com.afm.vhc.LogRecordImpl.findWithQuery(query));
    }
     ...
     */
    public static synchronized com.afm.vhc.PersonalizationParameters getPersonalizationParameters()
    {
        return (com.afm.vhc.PersonalizationParameters) DELEGATE.getPersonalizationParameters();
    }
    /**
     ...
     * @param context The user provided context.
     * @param uploadOnly If true, the synchronization is to send data from client to server only for non-DOE.
     * @param listener The user defined synchronization status listener.
     *  This parameter is ignored for DOE applications.
     */
    public static void beginSynchronize(com.sybase.collections.GenericList<com.sybase.persistence.SynchronizationGroup> sgs,Object context, boolean uploadOnly, com.sybase.persistence.SyncStatusListener listener)
    {
        if (DELEGATE instanceof com.sybase.sup.client.persistence.RbsDatabaseDelegate)
        {
            ((com.sybase.sup.client.persistence.RbsDatabaseDelegate)DELEGATE).beginSynchronize(sgs, context, uploadOnly, false, listener);
        }
        else
        {
            DELEGATE.beginSynchronize(sgs, context, uploadOnly);
    ...
    /**
     * Resumes the pending synchronization
     * 
     * @return YES if the pending synchronization is resumed.
               NO if there is no synchronization pending.
     */
    public static boolean ResumePendingSynchronization()
    {
        if (DELEGATE instanceof com.sybase.sup.client.persistence.RbsDatabaseDelegate)
        {
            return ((com.sybase.sup.client.persistence.RbsDatabaseDelegate)DELEGATE).ResumePendingSynchronization();
        }
    ...
    /**
     * Cancels the pending synchronization
     * 
     * @return YES if the pending synchronization is cancelled. 
               NO if there is no synchronization pending.
     */
    public static boolean CancelPendingSynchronization()
    {
        if (DELEGATE instanceof com.sybase.sup.client.persistence.RbsDatabaseDelegate)
        {
            return ((com.sybase.sup.client.persistence.RbsDatabaseDelegate)DELEGATE).CancelPendingSynchronization();
        }
    ...
    {
        com.afm.vhc.ChangeLogImpl.deleteChangeLogs();
    }
