...
{
    private static com.afm.vhc.intrnl.ChangeLogKeyMetaData META_DATA = new com.afm.vhc.intrnl.ChangeLogKeyMetaData();
    ...
    protected static com.sybase.sup.client.persistence.ClassDelegate DELEGATE = 
        new com.sybase.sup.client.persistence.ClassDelegate("ChangeLogKey", com.afm.vhc.ChangeLogKey.class, META_DATA, com.afm.vhc.VHCDB.getDelegate());
    
    /**
     * Creates an instance of com.afm.vhc.ChangeLogKey  
     */
    public ChangeLogKey()
    {
