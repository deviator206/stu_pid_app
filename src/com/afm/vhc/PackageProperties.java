...
public  class PackageProperties extends com.sybase.persistence.AbstractEntity implements com.sybase.persistence.MobileBusinessObject, com.sybase.sup.client.persistence.AbstractPackageProperties, com.sybase.reflection.ClassWithMetaData
{
    ...
    private static com.afm.vhc.intrnl.PackagePropertiesMetaData META_DATA = new com.afm.vhc.intrnl.PackagePropertiesMetaData();
    ...
    protected static com.sybase.sup.client.persistence.EntityDelegate DELEGATE = 
        com.sybase.sup.client.persistence.DelegateFactory.createEntityDelegate("PackageProperties", com.afm.vhc.PackageProperties.class, "VHC.PackageProperties", META_DATA, com.afm.vhc.VHCDB.getDelegate());
    ...
    /**
     * Creates an instance of com.afm.vhc.PackageProperties  
     */
     ...
     */
    public static com.afm.vhc.PackageProperties find(java.lang.String id)
    {
        ...
        try
        {
            ...
            return (com.afm.vhc.PackageProperties)(DELEGATE.findEntityWithKeys(keys));
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     */
    public static com.afm.vhc.PackageProperties load(java.lang.String id)
    {
        return (com.afm.vhc.PackageProperties)(DELEGATE.load(id));
    }
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PackageProperties> findWithQuery(com.sybase.persistence.Query query)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PackageProperties>)(Object)DELEGATE.findWithQuery(query, com.afm.vhc.PackageProperties.class);
    }
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PackageProperties> getPendingObjects(int skip, int take)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PackageProperties>)(Object)DELEGATE.getPendingObjects(skip, take);
    }
    
    /**
     * Returns the MBOs that are updated locally but not submmited.  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PackageProperties> getPendingObjects()
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PackageProperties>)(Object)DELEGATE.getPendingObjects();
    }
    ...
    {
        return com.afm.vhc.LogRecordImpl.findByEntity("PackageProperties", keyToString());
    }
    ...
    public com.afm.vhc.PackageProperties getDownloadState()
    {
        return (com.afm.vhc.PackageProperties)i_getDownloadState();
    }
    
    public com.afm.vhc.PackageProperties getOriginalState()
    {
        return (com.afm.vhc.PackageProperties)i_getOriginalState();
    }
