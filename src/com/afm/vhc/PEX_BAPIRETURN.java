...
public  class PEX_BAPIRETURN extends com.sybase.persistence.AbstractEntity implements com.sybase.persistence.MobileBusinessObject, com.sybase.reflection.ClassWithMetaData
{
    /** Begin code region: MetaData **/
    private static com.afm.vhc.intrnl.PEX_BAPIRETURNMetaData META_DATA = new com.afm.vhc.intrnl.PEX_BAPIRETURNMetaData();
    ...
    protected static com.sybase.sup.client.persistence.EntityDelegate DELEGATE = 
        com.sybase.sup.client.persistence.DelegateFactory.createEntityDelegate("PEX_BAPIRETURN", com.afm.vhc.PEX_BAPIRETURN.class, "VHC.PEX_BAPIRETURN", META_DATA, com.afm.vhc.VHCDB.getDelegate());
    ...
    /**
     * Creates an instance of com.afm.vhc.PEX_BAPIRETURN  
     */
    public PEX_BAPIRETURN()
    {
    ...
    public static com.afm.vhc.PEX_BAPIRETURN find(long id)
    {
        ...
        try
        {
            ...
            return (com.afm.vhc.PEX_BAPIRETURN)(DELEGATE.findEntityWithKeys(keys));
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     */
    public static com.afm.vhc.PEX_BAPIRETURN load(long id)
    {
        return (com.afm.vhc.PEX_BAPIRETURN)(DELEGATE.load(id));
    }
    ...
    /**
     * Find a List of PEX_BAPIRETURN
     * @param query The query to be filter.
     * @exception PersistenceException Thrown if unable to retrieve mobile business object.
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN> findWithQuery(com.sybase.persistence.Query query)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN>)(Object)DELEGATE.findWithQuery(query, com.afm.vhc.PEX_BAPIRETURN.class);
    }
    
    /**
     * Find a List of Com.afm.vhc.PEX_BAPIRETURN
     * @exception PersistentException Thrown if unable to retrieve mobile business object.
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN> findAll(int skip, int take)
    {
        String intervalName = null;
        if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
        {
            intervalName = "PEX_BAPIRETURN.findAll";
            com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.getInstance().startInterval(intervalName, com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.PersistenceRead);
        }
        try
        {
            String _selectSQL = "select " + " x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"pending\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"i\",x.\"_rc\",x.\"_ds\",x.\"cvpOperation_length\",x.\"cvpOperationLobs_length\" FROM \"vhc_1_0_pex_bapireturn\" x where (((x.\"pending\" = 1 or not exists (select x_os.\"i\" from \"vhc_1_0_pex_bapir"
                                                + "eturn_os\" x_os where x_os.\"i\" = x.\"i\"))))"; 
            return (com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN>)(Object)DELEGATE.findWithSQL(skip, take, _selectSQL, com.afm.vhc.PEX_BAPIRETURN.class);
        }
        finally
        {
            if(com.sybase.mobile.util.perf.impl.PerformanceAgentServiceImpl.isEnabled)
     ...
     * Find a list of com.afm.vhc.PEX_BAPIRETURN  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN> findAll()
    {
     ...
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN> getPendingObjects(int skip, int take)
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN>)(Object)DELEGATE.getPendingObjects(skip, take);
    }
    
    /**
     * Returns the MBOs that are updated locally but not submmited.  
     */
    public static com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN> getPendingObjects()
    {
        return (com.sybase.collections.GenericList<com.afm.vhc.PEX_BAPIRETURN>)(Object)DELEGATE.getPendingObjects();
    }
    ...
    {
        return com.afm.vhc.LogRecordImpl.findByEntity("PEX_BAPIRETURN", keyToString());
    }
    ...
    public com.afm.vhc.PEX_BAPIRETURN getDownloadState()
    {
        return (com.afm.vhc.PEX_BAPIRETURN)i_getDownloadState();
    }
    
    public com.afm.vhc.PEX_BAPIRETURN getOriginalState()
    {
        return (com.afm.vhc.PEX_BAPIRETURN)i_getOriginalState();
    }
